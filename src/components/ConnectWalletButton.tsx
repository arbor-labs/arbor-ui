				...
				<Popover className="relative">
					{({ close }) => (
						<>
							...
							>
								<Link href={`/users/${connectedAccount.address}`} onClick={() => close()}>
									<div className="block cursor-pointer rounded-md px-3 py-2 text-sm/6 font-semibold text-[--arbor-black] hover:bg-gray-100">
										Profile
									</div>
								</Link>
								<div
